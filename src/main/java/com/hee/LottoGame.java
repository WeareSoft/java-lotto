...
public class LottoGame {
    ...
    public LottoResult play(final String winningNumbersOfLastWeek) {
        Ticket winningTicket = new Ticket(winningNumbersOfLastWeek);
        LottoResult result = new LottoResult();
        this.tickets.forEach(ticket -> result.updateResult(Prize.valueOf(ticket.matchedCount(winningTicket))));;
        return result;
    }
}
